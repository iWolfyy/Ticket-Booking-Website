    ...
    <div className="embla">
      ...
      <div className="embla__controls">
        ...
        <div className="flex items-center gap-4 flex-1 justify-end">
           <div className="relative w-full max-w-[150px] h-1 bg-white/10 rounded-full overflow-hidden">
              <div 
                key={progressBarKey}
                className="absolute top-0 left-0 h-full bg-white/60 animate-carousel-progress"
                style={{ 
